...
export const SHOP_DETAIL = 'SHOP_DETAIL'  // 查询商户详情

export const SHOP_LIST = 'SHOP_LIST'  // 根据分类查询商户列表

export const LIST = 'LIST'  // 项目列表

export const USER = 'USER'  // 获取用户信息

export const COUPON = 'COUPON'  // 优惠券列表
