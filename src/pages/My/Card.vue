    ...
    <div id="card" v-if="user.wtCustomer">
        ...
        <div v-if="user.wtCustomer.phonenumber" class="card">
            <div class="card_vip">
                ...
                <div class="step" v-if="user.wtCustomer.phonenumber">
        ...
        <div class="Card_list">
            <div class="code"><span v-if="user.wtCustomer.phonenumber">NO：{{user.wtCustomer.cardno}}</span><span v-else><router-link to="/Opencard">绑定会员卡</router-link></span></div>
...
export default {
    ...
    created(){
        ...
        // this.$nextTick(()=>{
        //     this.$store.commit('HTML', this.getJFIllege.equity)
        // })
    },
    methods:{
        qrcodes() {
        ...
        change_list(index){
            ...
            if(index == 0){
                ...
                this.$store.commit('HTML', this.getJFIllege.regulations)
            }
        },
    }
}
    ...
    *{
    ...
    .Card_list{
        ...
        .code{ 
            ...
            .font1; font-size: 0.35rem; top: -0.2rem;
