    ...
    <div class="yuyue">
        ...
        <div class="Wallet_main">
            ...
            <div v-else class="integral_content content">
                <p>积分规则</p>
                <div class="regulations" v-html="html"></div>
            </div>
        </div>
	...
	export default {
        ...
        computed:{
            ...
            html(){
                ...
                return this.$store.state.user.card[0].integralRules.replace(/;/g,'').replace(/&gt/g,'>').replace(/&lt/g,'<').replace(/&apos/g,"'").replace(/&quot/g,"\\")
            },
            getIntegralHis(){
...
.Wallet_main{
    ...
    .integral_content{
        ...
        .add_reduce{
            ...
            border-bottom: 0.02rem solid rgba(206,206,206,1); line-height: 0.4rem; padding-top: 0.48rem;
            .date{
