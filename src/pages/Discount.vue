...
<style lang="less" scoped>
    #Discount{
        width: 100%; min-height: calc(100vh - 1.1rem); padding-bottom: 1.1rem; background-color: rgba(232,232,232,1);; padding-top: 1rem;
    }
    ...
    *{
    ...
    .Discount{
        ...
        .Discount_list{
            width: 6.7rem; height: 3.88rem; margin: 0.48rem auto; background-color: white; border-radius: 0.1rem; position: relative;
